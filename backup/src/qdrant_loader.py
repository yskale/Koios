...
client = QdrantClient(url="http://localhost:63722/")
...
def read_vector_embed(collect_name):
    input_directory ="/Users/ykale/Documents/Dev/koios/Koios/question_embedding"
    records = []
    main_index= 1
...
def create_a_collection_qdrant(collect_name):
    ...
    client.recreate_collection(
        ...
        vectors_config=VectorParams(size=vector_size, distance='Cosine')  # You can change 'Cosine' to 'Euclidean' or 'Dot' as needed
    )


collect_name = 'test_collection1'
